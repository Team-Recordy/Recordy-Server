...
public interface ReportApi {
    @Operation(
            ...
            responses = {
                                    ...
                                    examples = {
                                            @ExampleObject(
                                                    value = """
                                                            {
                                                                "errorCode": "500 INTERNAL SERVER ERROR",
                                                                "errorMessage": "슬랙 메세지 전송에 실패했습니다."
                                                            }
                                                            """
                                            )
                                    },
                    ...
                    @ApiResponse(
                            responseCode = "500 (3)",
                            description = "슬랙 상호작용 인터렉션에 문제가 발생했습니다.",
                            content = @Content(
                                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                                    examples = {
                                            @ExampleObject(
                                                    value = """
                                                            {
                                                                "errorCode": "500 INTERNAL SERVER ERROR",
                                                                "errorMessage": "슬랙 상호작용 인터렉션에 문제가 발생했습니다."
                                                            }
                                                            """
                                            )
                                    },
