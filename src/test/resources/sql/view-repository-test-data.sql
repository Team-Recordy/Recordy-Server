...
insert into `records` (`id`, `user_id`, `content`,`thumbnail_url`, `video_url`, `is_blocked`)
values (1, 1, 'content', 'thumbnail_url', 'video_url', false);

insert into `records` (`id`, `user_id`, `content`,`thumbnail_url`, `video_url`, `is_blocked`)
values (2, 1, 'content', 'thumbnail_url', 'video_url', false);